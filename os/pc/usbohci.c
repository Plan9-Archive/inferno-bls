 ...
 */
static void
qhinterrupt(Ctlr *ctlr, Ep *ep, Qio *io, Td *td, int)
{
	Block *bp;
	int mode, err;
	Ed *ed;
...
/*
	For reasons I don't understand, if there's nothing attached
	to any port, this doesn't take effect at this point, but does
	later.
